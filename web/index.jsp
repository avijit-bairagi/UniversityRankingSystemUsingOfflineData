...
<header class="main-header" id="header">
    <div class="bg-color">
            ...
            <div class="container">
                <div class="col-md-12">
                    <div class="navbar-header">
                        ...
                        <a href="index.jsp" class="navbar-brand">University</a>
                    </div>
        ...
        <!--/ nav-->
        <form action="rankList.jsp" method="post">
        <div class="container text-center">
            <div class="wrapper wow fadeInUp delay-05s">
                <h2 class="top-title">View Top</h2>
                <h3 class="title">University</h3>
                <h4 class="sub-title">Here we take best feature to rank.</h4>
                <button type="submit" class="btn btn-submit">View Rank</button>
            </div>
        </div>
        </form>
    </div>
...
<!---->
<!---->
<section id="feature" class="section-padding text-center">
    <div>
        &nbsp;
        &nbsp;
        &nbsp;
